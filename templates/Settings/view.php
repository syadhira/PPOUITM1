    ...
    <div class="column column-80">
        <div class="settings view content">
            ...
            <table>
                ...
                <tr>
                    <th><?= __('Ribbon Title') ?></th>
                    <td><?= h($setting->ribbon_title) ?></td>
                </tr>
                <tr>
                    <th><?= __('Ribbon Link') ?></th>
                    <td><?= h($setting->ribbon_link) ?></td>
                </tr>
                <tr>
                    <th><?= __('Notification Date') ?></th>
                    <td><?= h($setting->notification_date) ?></td>
                </tr>
                <tr>
                    <th><?= __('Created') ?></th>
                ...
                <tr>
                    ...
                    <td><?= $setting->notification_status ? __('Yes') : __('No'); ?></td>
                </tr>
                <tr>
                    <th><?= __('Ribbon Status') ?></th>
                    <td><?= $setting->ribbon_status ? __('Yes') : __('No'); ?></td>
                </tr>
            </table>
            <div class="text">
            ...
            <div class="text">
                ...
                <blockquote>
                    <?= $this->Text->autoParagraph(h($setting->notification)); ?>
                </blockquote>
            </div>
        </div>
    </div>
