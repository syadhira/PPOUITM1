        ...
        <table>
            <thead>
                <tr>
                    ...
                    <th><?= $this->Paginator->sort('notification_date') ?></th>
                    <th><?= $this->Paginator->sort('ribbon_title') ?></th>
                    <th><?= $this->Paginator->sort('ribbon_link') ?></th>
                    <th><?= $this->Paginator->sort('ribbon_status') ?></th>
