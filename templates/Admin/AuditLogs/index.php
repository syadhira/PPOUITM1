	...
	<div class="col-md-9">
		...
		<div class="tab-content px-0">
							...
							<table class="table table-sm table-border mb-4 table_transparent table-hover">
								...
								<?php foreach ($auditLogs as $auditLog) : ?>
									<tr>
										...
										<td><?php echo $this->Number->format($auditLog->id) ?></td>
										<td>
											<?php
			...
			<div class="tab-pane fade" id="navs-top-report" role="tabpanel">
				...
				<div class="row">
					<div class="col-md-4">
						<div class="card bg-body-tertiary border-0 stat_card shadow mb-4 card-1">
							<h3><?php echo $total_auditLogs; ?></h3>
							<p>Total Audit Logs</p>
						</div>
					</div>
					<div class="col-md-4">
						<div class="card bg-body-tertiary border-0 stat_card shadow mb-4 card-2">
							<h3><?php echo $total_auditLogs_active; ?></h3>
							<p>Active Audit Logs</p>
						</div>
					</div>
					<div class="col-md-4">
						<div class="card bg-body-tertiary border-0 stat_card shadow mb-4 card-3">
				...
				<div class="row">
					<div class="col-md-6">
						<div class="card bg-body-tertiary border-0 shadow mb-4">
							<div class="card-body">
								<div class="card-title mb-0">Audit Logs (Monthly)</div>
					...
					<div class="col-md-6">
						<div class="card bg-body-tertiary border-0 shadow mb-4">
							<div class="card-body">
								<div class="card-title mb-0">Audit Logs by Status</div>
								<div class="tricolor_line mb-3"></div>
								<div class="chart-container" style="position: relative;">
				...
				<div class="row pb-3">
					<div class="col-md-3 mb-2">
						<a href='<?php echo $combine; ?>/csv' class="kosong">
							<div class="card border shadow bg-body-tertiary">
								<div class="card-body">
									<div class="row mx-0">
