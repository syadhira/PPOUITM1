			...
			<div class="tab-pane fade" id="navs-top-report" role="tabpanel">
				...
				<div class="row">
					<div class="col-md-6">
						<div class="card bg-body-tertiary border-0 shadow mb-4">
							<div class="card-body">
								<div class=" card-title mb-0">User (Monthly)</div>
					...
					<div class="col-md-6">
						<div class="card bg-body-tertiary border-0 shadow mb-4">
							<div class="card-body">
								<div class=" card-title mb-0">User by Status</div>
								<div class="tricolor_line mb-3"></div>
								<div class="chart-container" style="position: relative;">
	...
	<div class="col-md-3">
		...
		<div class="card bg-body-tertiary border-0 shadow mb-4">
			<div class="card-body text-body-secondary">
				...
				<fieldset>
					<div class="mb-1"><?php echo $this->Form->control('fullname', ['required' => false, 'class' => 'form-control border-0']); ?></div>
					<div class="mb-1"><?php echo $this->Form->control('email', ['required' => false, 'class' => 'form-control border-0']); ?></div>
