		...
		?>
            ...
            <tbody>
				...
				<td><?php echo $counter++ ?></td>
                    ...
                    <td><?= $application->hasValue('faculty') ? $this->Html->link($application->faculty->name, ['controller' => 'Faculties', 'action' => 'view', $application->faculty->id]) : '' ?></td>
                    <td><?= $application->hasValue('program') ? $this->Html->link($application->program->name, ['controller' => 'Programs', 'action' => 'view', $application->program->id]) : '' ?></td>
                    <td><?= $application->hasValue('appointment') ? $this->Html->link($application->appointment->code, ['controller' => 'Appointments', 'action' => 'view', $application->appointment->id]) : '' ?></td>
                    <td><?= $application->hasValue('branch') ? $this->Html->link($application->branch->code, ['controller' => 'Branches', 'action' => 'view', $application->branch->id]) : '' ?></td>
