...
<div class="row">
	<div class="col-md-9">
		<div class="card rounded-0 mb-3 bg-body-tertiary border-0 shadow">
            ...
            <h3><?= h($appointment->code) ?></h3>
    <div class="table-responsive">
        <table class="table">
                <tr>
                    <th><?= __('Code') ?></th>
                    <td><?= h($appointment->code) ?></td>
                </tr>
                <tr>
                    <th><?= __('Session') ?></th>
                    <td><?= h($appointment->session) ?></td>
                </tr>
                <tr>
                    <th><?= __('Id') ?></th>
                ...
                <tr>
                    <th><?= __('Status') ?></th>
                    <td><?= $this->Number->format($appointment->status) ?></td>
                </tr>
                <tr>
                    <th><?= __('Created') ?></th>
            ...
            <div class="card-body text-body-secondary">
                ...
                <?php if (!empty($appointment->applications)) : ?>
                <div class="table-responsive">
                    <table class="table">
                        <tr>
                            <th><?= __('Id') ?></th>
                        ...
                        <?php foreach ($appointment->applications as $applications) : ?>
                        <tr>
