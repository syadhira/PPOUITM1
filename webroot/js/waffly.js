        ...
        this.each(function () {
            ...
            if (settings.graph_value.indexOf(".") > -1) {
                ...
                if (gvalue[1].length > 3) {
                    settings.graph_value =
                        parseFloat(settings.graph_value).toFixed(2) + "%";
                }
            }
            ...
            if (settings.style_override) {
                ...
                if ($(this).data("waffly-title")) {
                    obj +=
                        '<div class="waffly_title">' +
                        $(this).data("waffly-title") +
                        "</div>";
                }
                ...
                obj =
                    '<div class="' +
                    settings.class_name +
                    '" style="-webkit-box-sizing: border-box;-moz-box-sizing: border-box;box-sizing: border-box;font-family:' +
                    settings.graph_font +
                    ";padding:" +
                    settings.graph_margin +
                    ";width:" +
                ...
                dot_width = Math.floor(
                    (settings.graph_width -
                        parseInt(settings.graph_margin) * 2 -
                        (settings.dot_row - 1) * settings.dot_gap) /
                        settings.dot_row
                );

                obj +=
                    '<ul class="waffly_dots" style="font-size:0;list-style:none;margin:0;padding:0;">';
                ...
                if (settings.default_color === "") {
                    ...
                    opacity_styles +=
                        ...
                        settings.dot_opacity * 100 +
                        ")';" +
                        "filter: alpha(opacity=" +
                        settings.dot_opacity * 100 +
                        ");-moz-opacity: " +
                        settings.dot_opacity +
                        ";-khtml-opacity: " +
                        settings.dot_opacity +
                        ";opacity:" +
                        settings.dot_opacity +
                ...
                if ($(this).data("waffly-title")) {
                    obj +=
                        '<div class="waffly_title" style="color:' +
                        settings.graph_title_color +
                        ';margin-top:.75em;text-align:center">' +
                        $(this).data("waffly-title") +
                        "</div>";
                }
            ...
            if (settings.graph_reverse) {
                $(this)
                    .find(".waffly_dots")
                    .append($(this).find(".waffly_dot").get().reverse());
            }
                ...
                if (settings.style_override) {
                    ...
                    if (settings.graph_reverse) {
                        $dots.each(function (index, el) {
                            setTimeout(function () {
                                $dots
                                    .eq(Math.abs(index - $dots.length + 1))
                                    .addClass("sel");
                            }, 500 + index * 20);
                        });
                    } else {
